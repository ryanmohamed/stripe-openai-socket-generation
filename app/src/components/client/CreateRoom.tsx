...
const CreateRoom = ({ extraStyles }: { extraStyles?: string }) => {
    ...
    if (!roomID) {
        return (
            <div className={`flex-grow flex flex-col w-48 border-2 border-stone-800 p-4 rounded-md ${extraStyles}`}>
                <h1 className="text-center mb-4 text-xl border-b-2 border-stone-800 text-stone-400 font-poppins font-semibold">Create a Room</h1>
    ...
    return (
        <div className={`flex-grow flex flex-col w-48 border-2 border-stone-800 p-4 rounded-md ${extraStyles}`}>
            <h1 className="text-center mb-4 text-xl border-b-2 border-stone-800 text-stone-400 font-poppins font-semibold">Room {roomID}</h1>
            <div className="mb-4">
