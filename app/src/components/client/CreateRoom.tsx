    ...
    if (!roomID) {
        return (
            <div className={`flex-grow flex flex-col px-4 py-10 justify-center items-center ${extraStyles}`}>
                ...
                <button onClick={handleCreate} className="h-14 w-1/2 px-2 rounded-md text-lg font-poppins font-semibold text-stone-300 bg-green-800 hover:bg-green-600 transition-colors" type="button">Request Room</button>
