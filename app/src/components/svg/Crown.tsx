const Crown = ({ fill, className }: { fill?: string; className?: string; }) => {
    return (
        <svg fill={fill} className={className} height="24px" width="24px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 220 220">
